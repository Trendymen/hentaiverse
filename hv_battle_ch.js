...
// @grant        GM_addStyle
// @grant        unsafeWindow
// @downloadURL https://update.sleazyfork.org/scripts/445520/HV%20-%20%E6%88%98%E6%96%97%E6%97%A5%E5%BF%97%E6%B1%89%E5%8C%96.user.js
// @updateURL https://update.sleazyfork.org/scripts/445520/HV%20-%20%E6%88%98%E6%96%97%E6%97%A5%E5%BF%97%E6%B1%89%E5%8C%96.meta.js
// ==/UserScript==
...
///////////////////////////////////////////武器种类
        ...
        ///////////////////////////////////////////防具后缀////////////////////////////////////////////
        'of Negation':'否定(抵抗+)',
        'of the Shadowdancer':'影舞者(闪避/攻暴+)',
        'of the Arcanist':'奥术师(智力/智慧/魔命+)',
        'of the Fleet':'迅捷(闪避+)',
        ...
        'of the Nimble':'招架(招架+)',
        'of the Barrier':'格挡(格挡+)',
        'of Protection':'物防(物减伤+)',
        'of Warding':'魔防(魔减伤+)',
