...
(function () {
    ...
    var dictsMap = {
        ...
        '#ability_info' : [true, 'skills', 'abilityInfo', 'ability', 'items'], //技能悬浮窗，需监听动态翻译
        ...
        '#upgrade_text' : [true, 'monsterLabs', 'items'], //怪物实验室的升级强化需求提示，需要监听动态翻译
        '#shrine_left' : ['artifact'], //祭坛左侧物品列表
        '#shrine_right' : ['shrine'], //祭坛右侧说明
        '#accept_equip' : ['equipsPart'], //装备献祭选项
        '#shrine_offertext' : [true, 'artifact', 'shrine'], //祭坛献祭物品动态说明，需要动态监听
        '#mmail_outer' : ['mm'], //邮件
...
//除非上面字典分区中被指派到同一个翻译部分，否则各个部分之间互相独立
//必要时有些翻译词条也会重复出现在多个部分中（这样比同时使用多个部分字典更有效率）
//但尽可能还是将相同内容放在一个分区里，这样更便于集中管理
var words = {
    /*
    NOTE:
    ...
    */
    ...
    alerts: {
        ...
        'Are you sure you want to attach the protected equipment': '是否确认添加这件被保护的装备到邮件附件？',
    ...
    messagebox: {
        ...
        'The selected equipment does not exist.' : '所选装备不存在',
        ...
        '/Bought (\\d+) equipment for ([\\d,]+ Credits)/' : '以 $2 购买了 $1 件装备',
        '/Bought (.+) for ([\\d,]+ Credits)/' : '以 $2 购买了 $1',
        '/Sold (.+) equipment for ([\\d,]+ Credits)/' : '以 $2 出售了 $1 件装备',
        '/Sold (.+) for ([\\d,]+ Credits)/' : '以 $2 出售了 $1',
        ' the salvage remains' : '拆解残余报废装备',
        'Sold the remains for' : '出售分解残余获得',
        ...
        'Equipment is either in use, locked, stored, or cannot be traded, kupo!' : '装备要么正在使用，要么被锁定/被存储，或者不可交易！咕波！',
        ...
        'Could not reserve the selected items. Usually this means they are no longer available.' : '无法操作选中物件，一般来说这意味着它已经不存在了。',
    ...
    abilityInfo: {
        ...
        'Increases your attack crit damage' : '增加你的物理暴击伤害，',
        ...
        'Attack Crit Multiplier': '攻击暴击伤害倍率',
        'Attack Accuracy' : '物理命中率',
        'Attack Speed' : '行动速度',
        'Magic Cast Speed' : '法术咏唱速度',
        'Magic Accuracy' : '魔法命中率',
        'Magic Crit Chance' : '魔法暴击率',
        'Spell Critical Multiplier' : '法术暴击伤害倍率',
        'Spell Crit Multiplier' : '法术暴击伤害倍率',
        'Block Chance' : '格挡率',
        'Parry Chance' : '招架率',
        ...
        'Increase the duration of the Immobilize spell, and add a slowing effect. Higher levels increase the number of targets affected per cast, and reduces the cooldown of the spell.' : '增加“固定”咒语的持续回合数并且附加缓慢效果。高等级增加每次施放影响的目标数，也缩短咒语的冷却时间。',
        ...
        'Augment the Drain spell with the ability to inflict Ether Theft on any target afflicted with Soul Fire.' : '此技能扩充“枯竭”咒语的能力，可对任何受焚烧的灵魂(圣特殊效果)折磨的目标强加魔力汲取效果。',
        'Augment the Drain spell with the ability to inflict Spirit Theft on any target afflicted with Ripened Soul.' : '此技能扩充“枯竭”咒语的能力，可对任何受鲜美的灵魂(暗特殊效果)折磨的目标强加灵力汲取效果。',
        'Action Speed Modification' : '行动速度变化',
        'Natural Resist Modifier' : '原始抵抗倍率',
        'Added special effect: Ether Theft' : '附加特殊效果：魔力汲取',
        'Added special effect: Spirit Theft' : '附加特殊效果：灵力汲取',
        'Followup' : '追加',
        ...
        'Natural Evade Modifier' : '原生闪避概率',
        'Shadow Veil Trigger Chance' : '“影纱”触发概率',
        ...
        'Heartseeker will further increase the damage of any critical melee hits.' : '“穿心”会额外增加任何近战暴击的伤害。',
        ...
        'Base Health Regen' : '基础体力恢复速率',
        'Base Mana Regen' : '基础法力恢复速率',
        'Base Spirit Regen' : '基础灵力恢复速率',
        'Evade' : '闪避率',
    ...
    itemInfos: {
        ...
        //强化材料
        'A cylindrical object filled to the brim with magitech energy. Used to power charms and advanced equipment.' : '一个边缘充斥着神秘科技能量的圆柱形物体，用于修复高级装备和护符',
        ...
        'Used to power Aether Charms.' : '用于充能以太护符',
        'Featherweight Charm enchantment' : '轻如鸿毛 的附魔效果',
        'Used to power Featherweight Charms.' : '用于充能轻羽护符',
        'Voidseeker\'s Blessing enchantment' : '虚空探索者的祝福 的附魔效果',
        'Used to power Voidseeker Charms.' : '用于充能虚空护符',
        'Can be used to reset the unlocked potencies and experience of an equipment piece.' : '可以用于重置装备的潜能等级',
        'Can be used to create a new world inside an equipment piece. Clearing this world will allow you to upgrade it further.': '用于探索装备内藏得潜能世界。清通道具界将允许你进一步强化装备',
        ...
        'These fragments can be used in the forge to permanently soulbind an equipment piece to you, which will make it level as you do.' : '这个碎片可以将一件装备与你灵魂绑定，灵魂绑定的装备会随着你的等级一同成长。',
    ...
    equipsInfo: {
        ...
        'Salvaged - Repair Required': '已分解 - 必须修理后才可使用',
        '/Dropped by (.+) for $/': '由怪物 $1 掉落于玩家 ',
        'Rewarded from Snowflake\'s Shrine to': '由雪花女神于祭坛赠与玩家 ',
        'Rewarded as a Clear Bonus to': '由通关奖励给',
        ' on ' : ' ',
    ...
    armory: {
        ...
        "Stat Fusion lets you improve Legendary+ equipment by sacrificing another Legendary+ equipment together with various materials to increase its base stats. (Persistent Only)": "属性融合允许您通过牺牲另一件传奇以上装备并消耗各种材料来提升传奇以上装备的基础属性。（仅限持久模式）",
        "Materials for upgrades and stat fusion can be obtained from salvaging unwanted equipment or raising monsters in the Monster Lab, or purchased from other players in The Market.": "升级和属性融合的材料可通过分解装备、怪物实验室获取，或在集市向其他玩家购买。",
        ...
        "Set To Protected": "设为保护状态",
        "Remove Lock": "移除锁定状态",
        "Remove Protection": "移除保护状态",
        "Change To Locked": "改为锁定状态",
        "Change To Protected": "改为保护状态",
        "Force Unequip": "强制解除装备",
        "Move To Storage": "移动到存储",
        "Move From Storage": "从存储中移出",
        ...
        "You can only upgrade soulbound equipment.": "你只能升级已经灵魂绑定的装备",
        "You are missing the required materials and credits to perform this upgrade.": "你缺少用于升级这件装备的材料和Credits",
        "You have to clear an additional floor in the Item World to upgrade this further.": "在进一步升级之前你必须先清通一层这件装备的道具界",
        ...
        " CP": " 点数",
        "No Charm": "没有护符",
        "This charm is already attached in ": "此护符已经装配在了",
        "This charm cannot be attached due to the charm in ": "此护符无法装配，因为冲突的护符已经装配在了",
        "(Lesser)": "(次级)",
        "(Greater)": "(强效)",
        "Missing": "缺少",
        "Insufficient ": "缺少",
        ...
        "Equipped equipment is (obviously) used as an indicator for equipment that is currently equipped, even if it is in a different equipment set or profile. These cannot be stored; attempting this will be silently ignored.": "已装备的装备（显而易见）用于标识当前已穿戴的装备，即使它位于其他装备套装或角色档案中。这类装备无法存储，尝试存储将被静默忽略。",
        ...
        "You can also buy back soulbound, salvaged or untradeable equipment that you previously sold yourself, as well as salvage remains that was sold when you manually salvaged equipment. These cannot be bought by other players, but will only be available for a limited time.": "您还可以回购自己之前出售的已绑定灵魂、已分解或不可交易的装备，以及手动分解装备后出售的报废装备。这些物品其他玩家无法购买，但仅在有限时间内可回购。",
        ...
        "Excess inventory of tradeable equipment will be pruned regularly, and there are no guarantees for how long they will remain available.": "过剩库存将定期清理，无法保证它们能存在多久。",
        ...
        "After salvaging, in addition to the extracted materials, the equipment itself will turn into Salvage Remains. You can either keep these, or sell them for a small amount of credits. Salvage Remains are only listed under the Salvaged tabs; they cannot be equipped or modified unless they are repaired, which will restore them to their original condition.": "分解后，除提取的材料外，装备本身会变成分解残余报废装备。您可以选择保留在仓库中或以少量积分出售。分解残余报废装备仅在“已分解”标签下列出；除非进行修复，否则无法装备或改造，修复后将恢复原始状态。",
        "Repairing salvage remains will require all the materials you obtained from salvaging them, in addition to the normal repair materials for repairing from zero Condition and Energy.": "修复分解残余报废装备时，需要使用您在分解时获得的全部材料，外加用于从零耐久度和能量修复的常规维修材料。",
        "Note that it is no longer possible to extract materials that was spent upgrading equipment.": "请注意，已用于升级装备的材料已无法再提取。",
        "These will generally be available to buy back for up to a day, but you should not rely on this.": "通常情况下你会有一天的时间可以考虑买回，但你不应该依赖这个。",
        "Required Items:": "所需物品：",
        "Total Salvage:": "分解得到：",
        "Sell Salvage Remains": "出售分解残余报废装备",
        "Sell Salvaged Equipment": "出售分解残余报废装备",
        ...
        'If you manage to fight your way through, you will boost the latent potency of your equipment. This increases the total strength of the charms the equipment can handle, and allows you to upgrade it further.' : '如果你成功通关，你将提升装备的潜能。这将增加装备可承受的护符总强度，并允许你进一步升级装备。',
        'The number of rounds you will be fighting depends on the quality of your item. More powerful items will have more powerful monsters inside them, and the monsters get more powerful the deeper you go. The difficulty setting does not affect the difficulty in Item Worlds.' : '你将战斗的轮数取决于你装备的品质。更强大的装备中包含更强大的怪物，而且你越深入，怪物就越强大。难度设置不会影响道具界的难度。',
        'Spawning an item world requires a number of World Seeds, depending on its quality and number of item worlds cleared inside that particular equipment.' : '生成一个道具界需要一定数量的世界种子，具体数量取决于装备的品质以及该装备内已通关的道具界数量。',
    ...
    /////////////////////////////////////////////////////技能、技巧说明
        ...
        'A veil of shadows surround the target, causing monsters to occasionally whiff, and boosting Evade by' : '一层幻影面纱包围目标，怪物攻击更容易错失，同时提高回避率',
        ...
        'Immobilize the target, making it unable to evade attacks or spells.' : '固定目标，使它无法回避攻击和咒语',
    ...
    /////////////////////////////////////////////////////状态
        ...
        'The target has been immobilized, eliminating its chance to evade and reducing its magic resistance.' : '目标已被固定，削减它的回避和咒语抵抗',
