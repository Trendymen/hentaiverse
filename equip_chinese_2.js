...
// @version      2025.11.13
// @downloadURL https://update.sleazyfork.org/scripts/404119/HV%20%E7%89%A9%E5%93%81%E8%A3%85%E5%A4%87%E6%B1%89%E5%8C%96.user.js
// @updateURL https://update.sleazyfork.org/scripts/404119/HV%20%E7%89%A9%E5%93%81%E8%A3%85%E5%A4%87%E6%B1%89%E5%8C%96.meta.js
// ==/UserScript==
...
function loadEquips(){
    ...
    var equips = {
        ...
        'Axe':'斧（单）',
        'Club':'棍（单）',
        'Rapier':'<span style=\"background:#ffa500;color:#000000\" >西洋剑</span>（单）',
        //双手
        'Great Mace' : '重锤',
        'Scythe':'*镰刀（双）',
        'Longsword':'长剑（双）',
        ...
        'Kite Shield':'鸢盾',
        'Tower Shield':'*塔盾',
        'Force Shield':'<span style=\"background:#ffa500;color:#000000\" >力场盾</span>',
        ...
        'Shade':'<span style=\"background:#ffa500;color:#000000\" >暗影</span><span style=\"background:#666666;color:#FFFFFF\" >(轻)</span>',
        //重甲
        ...
        'of Niflheim':'<span style=\"background:#94c2f5;color:#000000\" >尼芙菲姆（冰伤）</span>',
        'of Mjolnir':'<span style=\"background:#f4f375;color:#000000\" >姆乔尔尼尔（雷伤）</span>',
        'of Freyr':'<span style=\"background:#7ff97c;color:#000000\" >弗瑞尔（风伤）</span>',
        ...
        ///////////////武器或者防具属性/////////////////
        'Radiant':'<span style=\"background:#ffffff\;color:#000000" >魔光的（魔伤）</span>',
        'Mystic':'神秘的（暴击）',
        'Charged':'<span style=\"color:red\" >充能的（加速）</span>',
        'Amber':'<span style=\"background:#ffff00\;color:#000000" >琥珀的（雷抗）</span>',
        'Mithril':'<span style=\"color:red\" >秘银的（低重）</span>',
        'Agile':'俊敏的（加速）',
        'Zircon':'<span style=\"background:#ffffff\;color:#5c5a5a" >锆石的（圣抗）</span>',
        'Frugal':'<span style=\"color:red\" >节能（省魔）</span>',
        'Jade':'<span style=\"background:#b1f9b1;color:#000000\" >翡翠的（风抗）</span>',
        'Cobalt':'<span style=\"background:#a0f4f4;color:#000000\" >钴石的（冰抗）</span>',
        'Ruby':'<span style=\"background:#ffa6a6;color:#000000\" >红宝石（火抗）</span>',
        'Onyx':'<span style=\"background:#cccccc;color:#000000\" >缟玛瑙（暗抗）</span>',
        'Savage':'<span style=\"color:red\" >残暴的（暴伤）</span>',
        'Reinforced':'坚固的（减伤）',
        'Shielding':'盾化的（格挡）',
        'Arctic':'<span style=\"background:#94c2f5;color:#000000\" >极寒之</span>',
        'Fiery':'<span style=\"background:#f97c7c;color:#000000\" >灼热之</span>',
        'Shocking':'<span style=\"background:#f4f375;color:#000000\" >闪电之</span>',
        'Tempestuous':'<span style=\"background:#7ff97c;color:#000000\" >风暴之</span>',
        ...
        /////////////////品质//////////
        'Flimsy ' : '薄弱 ',
        'Crude ':'<span style=\"background:#acacac;color:#000000\" >劣质</span> ',
        'Fair ':'<span style=\"background:#c1c1c1;color:#000000\" >一般</span> ',
        'Average ':'<span style=\"background:#dfdfdf;color:#000000\" >中等</span> ',
        'Superior ':'<span style=\"background:#fbf9f9;color:#000000\" >上等</span> ',
        'Fine ':'<span style=\"background:#b9ffb9;color:#000000\" >优质</span> ',
        'Exquisite':'<span style=\"background:#d7e698;color:#000000\" >✧精良✧</span>',
        'Magnificent':'<span style=\"background:#a6daf6;color:#000000\" >☆史诗☆</span>',
        'Legendary':'<span style=\"background:#ffbbff;color:#000000\" >✪传奇✪</span>',
        'Peerless':'<span style=\"background:#ffd760;color:#000000\" >☯无双☯</span>',
...
function loadExtra() {
    var dict = {
        ...
        'Heavy':'重',
        //论坛里的彩虹无双品质名
        'P(<[^<]+>)+e(<[^<]+>)+e(<[^<]+>)+r(<[^<]+>)+l(<[^<]+>)+e(<[^<]+>)+s(<[^<]+>)+s':'<span style=\"background:#ffd760;color:#000000\" >☯无双☯</span>',
